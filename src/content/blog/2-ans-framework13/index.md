...
![framework13 fermée](framework13_close.jpg)  
...
![le Framework13 ouvert, allumé, montrant une session Gnome](framework13_ouvert.jpg]


Ce que j’aime
---

### Une qualité perçue haut de gamme
La machine a un design épuré, largement inspiré des MacBooks.  
C’est sobre, élégant et pratique ; mention spéciale pour les vis torx, pour la plupart _captives_, ce qui permet de démonter / remonter l’ordinateur très facilement.  
Le seul bémol esthétique est peut-être la largeur des bords d’écran, imposants pour les standards actuels, mais ça reste correct.  

### Légèreté & robustesse
À 1,2 kg, la machine est facile à transporter. Elle ne se fait pas oublier dans un sac, mais ce n’est pas non plus trop lourd.  
On peut utiliser le même chargeur pour le téléphone et l’ordinateur, et ça, c’est agréable (même si ça tend à devenir la norme).  
...
![Un zoom sur le capot pour montrer un très léger renfoncement](framework13_dent.jpg)
...
![Une photo du clavier « clear » et du trackpad](fw13_clear_kbd.jpg)
...
![Une photo zoomée du clavier, en faisant attention, on peut voir des poils sous certaines touches comme la barre d’espace](fw13_kbd_zoom.jpeg)
